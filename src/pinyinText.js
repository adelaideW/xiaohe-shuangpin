...
/**
 * Trim a single Chinese passage to at most maxChars (never concatenates others).
 ...
 * @param {{ title: string, text: string, pinyin?: (string|null)[] }[]} [_extraPassages] ignored
 */
export function fitChinesePassage(passage, minChars, maxChars, _extraPassages = []) {
  void minChars
